<%-- 
    Document   : Home
    Created on : Jan 14, 2018, 3:42:05 PM
    Author     : vuongnguyen
--%>
                ...
                <div class="row">
                    ...
                    <s:form class="form-horizontal">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-readers">
                            <caption><a href="AddProduct.jsp" class="btn btn-info">Add product</a> </caption>
                            <!-- t head -->
                            <thead>
                                <tr>
                                    <th>Id</th>
                            ...
                            <tbody id="myTableSearch">
                                <c:forEach items="${lstPro}" var="pro">
                                    <tr>
                                        <td>
                                            ${pro.getId()}
                                        </td>
                                        ...
                                        <td><a href="EditProductAction?id=${pro.getId()}">Edit</a></td>
                                        <td><a href="DeleteProductAction?id=${pro.getId()}">Delete</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
